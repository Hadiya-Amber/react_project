    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Branches",
                columns: new[] { "Id", "Address", "BranchCode", "BranchName", "BranchType", "City", "CreatedAt", "CreatedBy", "Email", "IFSCCode", "IsActive", "IsDeleted", "ManagerName", "PhoneNumber", "State", "UpdatedAt", "UpdatedBy" },
                values: new object[,]
                {
                    { 1, "123 Banking Street, Financial District", "OBS001", "Main Branch", 0, "Mumbai", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "System", null, "OBSN0000001", true, false, "Rajesh Kumar", "+912222661234", "Maharashtra", null, null },
                    { 2, "Connaught Place, New Delhi", "OBS002", "Delhi Branch", 2, "New Delhi", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "System", null, "OBSN0000002", true, false, "Priya Sharma", "+911123456789", "Delhi", null, null },
                    { 3, "Koramangala, Bangalore", "OBS003", "Bangalore Branch", 1, "Bangalore", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "System", null, "OBSN0000003", true, false, "Sunita Reddy", "+918012345678", "Karnataka", null, null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OtpVerifications_Email_Code",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OtpVerifications_User_Purpose_Used",
                table: "OtpVerifications",
